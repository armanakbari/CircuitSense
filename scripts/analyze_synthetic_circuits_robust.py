#!/usr/bin/env python3
"""
This code get the generated netlists from a json file and clean the netlists format for lcapy.

It uses lcapy to generate symbolic equations for the circuits.
"""
